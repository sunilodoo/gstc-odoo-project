...
class ProductProduct(models.Model):
	...
	art_work_id = fields.One2many('art.work', 'product_id', string='Art Work') 
...
class ArtWork(models.Model):
    ...
    name = fields.Many2one('art.work.brand', string="Brand")
    blister_type = fields.Selection([('Blister','Blister')], default='Blister', string="Blister Type")	
    blister_image = fields.Binary(string="Blister Images")
    duplex_type = fields.Selection([('Duplex','Duplex')], default='Duplex', string="Duplex Type")
    duplex_image = fields.Binary(string="Duplex Images")
    label_type = fields.Selection([('Label','Label')], default='Label', string="Label Type")
    label_image = fields.Binary(string="Label Images")	
    product_id = fields.Many2one('product.product', 'Product') 
    date = fields.Date(string="Updated On", default=fields.Datetime.now)  
    
class ArtWorkBrand(models.Model):
    _name = "art.work.brand"
