...
class WhatsappInvoice(models.Model):
    ...
    def invoice_whatsapp(self):
        return {'type': 'ir.actions.act_window',
                ...
                'view_mode': 'form',
                'view_type': 'form',
                'context': {'default_template_id': self.env.ref('custom_whatsapp_chat.whatsapp_invoice_template').id},
                }
...
class WhatsappPurchase(models.Model):
    ...
    def purchase_whatsapp(self):
        return {'type': 'ir.actions.act_window',
                ...
                'view_mode': 'form',
                'view_type': 'form',
                'context': {'default_template_id': self.env.ref('custom_whatsapp_chat.whatsapp_purchase_template').id},
                }
...
class WhatsappSale(models.Model):
    ...
    def sale_whatsapp(self):
        return {'type': 'ir.actions.act_window',
                ...
                'view_mode': 'form',
                'view_type': 'form',
                'context': {'default_template_id': self.env.ref('custom_whatsapp_chat.whatsapp_sales_template').id},
                }
